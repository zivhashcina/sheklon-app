...
export default function HomeScreen() {
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-gradient-to-br from-blue-50 to-teal-100 p-6 animate-fadeIn transition-all duration-1000 ease-out">
      <img src="/logo.png" alt="שקלון לוגו" className="w-24 h-24 mb-4 animate-bounce" />
      <h1 className="text-3xl font-extrabold text-blue-800 mb-2 text-center">ברוכים הבאים לשקלון 💠</h1>
      <p className="text-gray-600 text-center mb-6">הקהילה שלך, הערך שלך</p>
